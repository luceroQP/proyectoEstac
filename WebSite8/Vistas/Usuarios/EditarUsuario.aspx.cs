...
public partial class Vistas_Usuarios_EditarUsuario : System.Web.UI.Page
{
    private string urlBack = "~/Vistas/Usuarios/ListadoUsuarios.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            int cod_usuario = (Int32)Session["cod_usuario"];
            Usuario usuarioEditado = new Usuario().buscarPorPK(cod_usuario, true);
            llenarRegiones();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (this.validarUsuario())
        {
            ...
            usuario.cod_usuario = (Int32)Session["cod_usuario"];
