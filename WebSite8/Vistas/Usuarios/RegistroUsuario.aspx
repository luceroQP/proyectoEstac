...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        $(document).on("ready", function () {
            ...
            <%
                if (Session["autoFocus"] != null)
                {
                    string elemento = (string)Session["autoFocus"];
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="col-md-12 row form-group">
            ...
            <div class="col-md-12 row">
                <asp:RequiredFieldValidator 
                    ...
                    InitialValue="0"
                    CssClass="error-message" 
                    ControlToValidate="dpd_tipo_usuario" 
                    ErrorMessage="Debe seleccionar tipo Usuario">
                </asp:RequiredFieldValidator>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div id="divProvincia" runat="server" visible="false" class="col-md-12 row form-group">
        ...
        <div id="divComuna" runat="server" visible="false" class="col-md-12 row form-group">
        ...
        <div class="col-md-12 row form-group">
            ...
            <div class="col-md-12 row">
                <asp:RequiredFieldValidator 
                    ...
                    Display="Dynamic" 
                    CssClass="error-message" 
                    ControlToValidate="txt_contraseña" 
    ...
    <div class="col-md-12 text-left">
        <h4 class="form-signin-heading">Tarjeta de Crédito</h4>
        <hr/>
    </div>
    <div class="col-md-4">
        <div class="col-md-12 row form-group">
            <asp:Label ID="Label10" runat="server" Text="Numero Tarjeta"></asp:Label>
            <asp:TextBox 
                ID="txt_nro_tarjeta"
                runat="server" 
                CssClass="form-control input-sm">
            ...
            <div class="col-md-12 row">
                <asp:RequiredFieldValidator 
                    ...
                    Display="Dynamic"
                    CssClass="error-message"  
                    ControlToValidate="txt_nro_tarjeta" 
                    ErrorMessage="Debe ingresar Numero de Tarjeta">
                </asp:RequiredFieldValidator>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="col-md-12 row">
            <asp:Label ID="Label12" runat="server" Text="Tipo Tarjeta"></asp:Label>
            <asp:DropDownList 
                ID="dpd_tipo_tarjeta" 
                runat="server" 
                CssClass="form-control input-sm" >
            ...
            <div class="col-md-12 row">
                <asp:RequiredFieldValidator 
                    ...
                    Display="Dynamic" 
                    CssClass="error-message" 
                    ControlToValidate="dpd_tipo_tarjeta" 
                    ErrorMessage="Seleccione Tipo Tarjeta">
                </asp:RequiredFieldValidator>
            </div>
        </div>
    </div> 
